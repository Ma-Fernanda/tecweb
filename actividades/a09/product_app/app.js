...
$(document).ready(function(){
    ...
    $('#product-form').submit(e => {
        ...
        const url = edit === false ? `http://localhost/tecweb/actividades/a09/product_app/backend/product`:`http://localhost/tecweb/actividades/a09/product_app/backend/product/${postData['id']}`;
